...
namespace FlightPath.Application.Infrastructure.AutoMapper
{
    ...
    public static class MapperProfileHelper
    {
        ...
        public static IEnumerable<IHaveCustomMapping> LoadAirportMappings(Assembly rootAssembly)
        {
            var types = rootAssembly.GetExportedTypes();
        ...
        public static IEnumerable<IHaveCustomMapping> LoadAircraftMappings(Assembly rootAssembly)
        {
            var types = rootAssembly.GetExportedTypes();
