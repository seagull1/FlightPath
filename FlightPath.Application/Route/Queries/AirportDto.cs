...
{
    public class AirportDto : IHaveCustomMapping, IComparable<AirportDto>
    {
        ...
        {
            configuration.CreateMap<Airport, AirportDto>()
                  .ForMember(cDTO => cDTO.Name, opt => opt.MapFrom(c => c.AirportName))
                  .ForMember(cDTO => cDTO.Id, opt => opt.MapFrom(c => c.Designator))
        ...
        {
            private readonly List<Sorter> list;
